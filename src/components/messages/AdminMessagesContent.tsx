...
const conversations: Conversation[] = [
  ...
  {
    id: "5",
    adTitle: "Specious House for Sale...",
    preview: "Please add clearer images of the product...",
    timeAgo: "2h ago",
    dot: "orange",
    status: "update_requested",
    messages: [
      {
        id: "m1",
        sender: "admin",
        text: "Please provide the exact address and more interior photos.",
        time: "06:50 AM",
      },
    ],
  },
  {
    id: "6",
    adTitle: "Single Jar Suction Machine ...",
    preview: "Please add clearer images of the product...",
    timeAgo: "2h ago",
    dot: "orange",
    status: "update_requested",
    messages: [
      {
        id: "m1",
        sender: "admin",
        text: "The product description is incomplete. Please add specifications.",
        time: "06:20 AM",
      },
    ],
  },
  {
    id: "7",
    adTitle: "Latitude 5410 i5 10th Gen ...",
    preview: "Please add clearer images of the product...",
    timeAgo: "2h ago",
    dot: "green",
    status: "active",
    messages: [
      {
        id: "m1",
        sender: "admin",
        text: "Please add the original bill of the laptop.",
        time: "05:45 AM",
      },
    ],
  },
  {
    id: "8",
    adTitle: "ECG Machine SINGLE CHAN...",
    preview: "Please add clearer images of the product...",
    timeAgo: "2h ago",
    dot: "red",
    status: "resolved",
    messages: [
      {
        id: "m1",
        sender: "admin",
        text: "Medical equipment requires certification documents. Please upload them.",
        time: "04:30 AM",
      },
    ],
  },
...
// ─── Avatar ───────────────────────────────────────────────────────────────────
// Matches the warm brown-toned person avatar visible in Figma
...
//
// Figma layout:
//   Admin  → [time] [bubble (gray, top-right corner sharp)] [avatar]
//   Seller → [avatar] [bubble (gray, top-left corner sharp)] [time]
...
export default function AdminMessagesContent() {
  ...
  return (
    <div className="py-4 md:pt-[28px] md:pb-[28px] px-4 md:pl-[28px] md:pr-4 w-full max-w-full flex flex-col">
      ...
      {/*
        Figma: light-gray outer card, rounded ~16px, subtle border.
        Left: #EFEFEF bg, "All Conversations" heading large + list of white cards.
        Right: white bg, chat header, bubbles, input row.
      */}
      <div
      ...
      >
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-white">
          ...
          <div className="px-[20px] md:px-[24px] pt-[16px] md:pt-[18px] pb-0">
            ...
            {/* Figma shows a thin divider line below the header row */}
          ...
          <div className="px-[16px] md:px-[20px] py-[14px] md:py-[16px]">
            <div className="flex items-center gap-[10px] md:gap-[12px]">
              ...
              {/* Send button — dark navy per Figma */}
              <button
                onClick={handleSend}
      ...
      {/* ── Mobile: Conversation list (below chat panel) ── */}
