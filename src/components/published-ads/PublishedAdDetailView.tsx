...
export default function PublishedAdDetailView({
  ...
  return (
    <div>
      ...
      {/* Ad title row — Poppins 400 24px 150% #000000 + "Ad is live" badge 89×28 radius 8 bg #028B20 */}
      <div className="flex items-center justify-between">
        <h2
          className="text-[#000000] text-[24px] font-normal leading-[150%]"
        ...
        {ad.isLive && (
          <span
            className="w-[89px] h-[28px] bg-[#028B20] rounded-[8px] text-white text-[12px] font-semibold inline-flex items-center justify-center shrink-0 ml-[16px]"
            style={{ fontFamily: "Poppins, sans-serif" }}
          >
            Ad is live
          </span>
      ...
      <div className="flex gap-[24px] mt-[16px]">
        ...
        <div className="flex-1 min-w-0">
          {/* Product image — 338×285 radius 8 border 0.5px #5E5E5E bg #D9D9D9 */}
          <div
            className="w-[338px] h-[285px] bg-[#D9D9D9] rounded-[8px]"
            style={{ border: "0.5px solid #5E5E5E" }}
          />

          {/* Specs — Eurostile 400 20px 100% tracking 4% */}
          <div className="mt-[20px] flex flex-col gap-[8px]">
            {[
              ...
              <div key={spec.label} className="flex items-center">
                <span
                  className="text-[#000000] text-[18px] font-normal leading-[100%] tracking-[0.04em] mb-2 "
                  style={{ fontFamily: "Eurostile, sans-serif" }}
                >
                  {spec.label} :
                </span>
                <span
                  className="text-[#5E5E5E] text-[18px] font-normal leading-[100%] tracking-[0.04em] ml-[8px] mb-2"
                  style={{ fontFamily: "Eurostile, sans-serif" }}
                >
                  {spec.value}
                </span>
        ...
        {/* Right column — gray panel containing all metadata */}
        <div
          className="w-[533px] shrink-0 rounded-[8px] p-[20px]"
        ...
        >
            ...
            <div className="flex flex-col gap-[12px]">
              ...
              <div className="flex items-center">
                <span
                  className="text-[#000000] text-[16px] font-normal leading-[150%] w-[130px] shrink-0"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  Seller :
                </span>
                <div className="flex items-center gap-[8px]">
                  ...
                  <span
                    className="text-[#000000] text-[14px] font-semibold"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    {ad.seller.name}
                  </span>
            ...
            {/* Seller's Mobile — overlaps top of Revisions Log card */}
            ...
            {/* Revisions Log — border 0.5px #000000, radius 8px */}
            {ad.revisions.length > 0 && (
              <div
                className="rounded-[8px] p-[16px]"
                style={{ border: "0.5px solid #000000" }}
              >
                <h4
                  className="text-[#000000] text-[16px] font-bold leading-[150%]"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  Revisions Log
                </h4>
                <div className="flex flex-col gap-[10px] mt-[12px]">
                  {ad.revisions.map((rev) => (
                    <div
                      key={rev.id}
                      className="bg-[#E0E0E0] rounded-[8px] px-[12px] py-[8px]"
                    >
                      <p
                      ...
                      <p
                        className="text-[#000000] text-[12px] font-semibold leading-[150%]"
                        style={{ fontFamily: "Poppins, sans-serif" }}
                      >
                        {rev.description}
                      </p>
          ...
          {/* Reviews — inside gray panel */}
          <div className="mt-[24px]">
            <div className="flex items-center gap-[10px]">
              <h4
                className="text-[#000000] text-[18px] font-bold leading-[150%]"
                style={{ fontFamily: "Eurostile, sans-serif" }}
              >
                Reviews :
              </h4>
              <span
                className="text-[#000000] text-[13px] font-normal border border-[#000000] rounded-[4px] px-[8px] py-[2px]"
                style={{ fontFamily: "Poppins, sans-serif" }}
              >
            ...
            <div className="flex flex-col gap-[10px] mt-[12px]">
              {ad.reviews.items.map((review) => (
                <div
                  key={review.id}
                  className="bg-[#EDEDED] rounded-[8px] px-[14px] py-[12px]"
                ...
                >
                    ...
                    <div className="flex items-center gap-[8px]">
                      ...
                      {review.verified && (
                        <span className="flex items-center gap-[4px]">
                          ...
                          <span
                            className="text-[#000000] text-[14px] font-normal leading-[100%]"
                            style={{ fontFamily: "Eurostile, sans-serif" }}
                          >
                            Verified Purchase
                          </span>
                  ...
                  <p
                    className="text-[#000000] text-[14px] font-normal leading-[150%] mt-[8px]"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    {review.text}
                  </p>
