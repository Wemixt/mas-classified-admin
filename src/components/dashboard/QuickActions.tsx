...
export default function QuickActions() {
  ...
  return (
    <div className="bg-[#DAECFF] rounded-[10px] overflow-hidden mt-4">
      ...
      {/* Buttons: 2x2 grid, 198x42 each, Poppins 500 14px */}
      <div className="grid grid-cols-2 gap-[16px] px-[34px] pt-[18px] pb-[32px]">
        {actions.map((action) => (
          <Link
            key={action.label}
            href={action.path}
            className="flex items-center justify-center gap-[8px] h-[42px] bg-[#1174BB] rounded-[8px] text-white text-[14px] font-medium leading-[100%] hover:bg-[#0E63A0] transition-colors"
          >
