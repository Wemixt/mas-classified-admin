      ...
      <div className="flex items-center justify-between gap-[12px] flex-wrap">
        ...
        {!selectedAd && (
          <button 
            ...
            className="bg-[#EBEBEB] hover:bg-[#E0E0E0] text-[#222222] h-[36px] md:h-[40px] px-[12px] md:px-[20px] rounded-[8px] text-[12px] md:text-[14px] font-semibold border border-[#D2D2D2] transition-colors shrink-0 ml-auto"
          >
            Export
          </button>
        )}
